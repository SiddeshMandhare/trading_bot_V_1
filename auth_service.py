...
from Dhan_Tradehull_V4 import Tradehull  # ✅ USING OFFICIAL LIBRARY
...
def create_tradehull_with_totp(client_code: str, pin: str, totp_secret: str, retries: int = 3) -> Optional[Tradehull]:
    ...
    for attempt in range(retries):
        try:
            ...
            print(f"🔐 Creating Tradehull instance with official library...")
            
            # ✅ Using official library - just pass client_code and token
